            ...
            },
            {
              ...
              render: function (data, type, row) {
                if (data !== null) {
                  ...
                  if (row.vanMember) {
                    return `${data} <span class="positive newtippy" data-tippy-content="Aktywuj dostawcę, a integracja rozpocznie się automatycznie" style="margin-left: 8px;">SmartVan</span>`;
                  }
                  return data;
                }
